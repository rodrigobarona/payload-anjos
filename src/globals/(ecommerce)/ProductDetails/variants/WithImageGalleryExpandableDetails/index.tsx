              ...
              <TabList className="grid grid-cols-4 gap-6">
                {product.images.map((image) => (
                  ...
                  >
                    ...
                    <span
                      aria-hidden="true"
                      className="group-data-selected:ring-indigo-500 pointer-events-none absolute inset-0 rounded-md ring-2 ring-transparent ring-offset-2"
                    />
                  </Tab>
                ))}
              </TabList>
                  ...
                  >
                    {product.colors.map((color) => (
                      ...
                      >
                        <span
                          aria-hidden="true"
                          className={cn(color.bgColor, "size-8 rounded-full border border-black/10")}
                        />
                      </Radio>
                    ))}
                  </RadioGroup>
